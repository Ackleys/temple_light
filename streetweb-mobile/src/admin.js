...
if ( window.ENV.production ) {
		window.URL_PREFIX = "/adminpage-mobile";      // http://dw.airm2m.com
		window.API_PREFIX = '/admin';
		window.QRcode_url = 'http://wxapp.mafu.shop/'
} else {
...
var init = function (){
	...
	ReactDOM.render((
		<Router history={browserHistory}>
			...
			<Route path={window.URL_PREFIX+"/devices_list"} component={App}>
				<IndexRoute component={Admin.DevicesList} />
			</Route>
