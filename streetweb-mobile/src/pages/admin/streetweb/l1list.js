...
var L1List = require('create-react-class')({
	...
	get_agent:function(page,psize){
		...
		let url = window.API_PREFIX+'/god/agent_devices/fetch?page='+page+'&psize='+psize;
		...
		let data = {agent_id:sessionStorage.getItem('getlist')-0};
		...
		return (
			<MyLayout>
				<div style = {{height:'8vh'}}>
					...
					<Button onClick = {function(){browserHistory.push(window.URL_PREFIX+'/level1')}}>返回</Button>
				</div>
				<Table
