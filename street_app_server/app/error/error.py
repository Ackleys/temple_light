...
# temple
ERROR_TEMPLE_NOT_FOUND = 12000
ERROR_TEMPLE_ALREADY_EXISTS = 12001
ERROR_HALL_NOT_FOUND = 12002
ERROR_LIGHT_NOT_FOUND = 12003
ERROR_DURATION_NOT_FOUND = 12004
...
error_info = {
  ...
  ERROR_TEMPLE_NOT_FOUND: ('寺庙不存在', 404),
  ERROR_TEMPLE_ALREADY_EXISTS: ('寺庙已存在', 409),
  ERROR_HALL_NOT_FOUND: ('大殿不存在', 404),
  ERROR_LIGHT_NOT_FOUND: ('灯不存在', 404),
  ERROR_DURATION_NOT_FOUND: ('时长不存在', 404),
}
